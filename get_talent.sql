...
CREATE TABLE `engineer` (
  ...
  `en_job_title` varchar(50) NOT NULL,
  `en_job_type` enum('freelance','fulltime') NOT NULL,
  `en_domisili` varchar(50) NOT NULL,
...
--
ALTER TABLE `account`
  MODIFY `acc_id` int(10) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=60;
...
--
ALTER TABLE `engineer`
  MODIFY `en_id` int(11) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=19;
